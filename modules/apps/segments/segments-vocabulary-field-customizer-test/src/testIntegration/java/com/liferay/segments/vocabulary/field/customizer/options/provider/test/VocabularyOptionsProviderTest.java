...
public class VocabularyOptionsProviderTest {
	...
	@Inject(
		filter = "(&(configuration.pid=com.liferay.segments.vocabulary.field.customizer.internal.configuration.SegmentsVocabularyFieldCustomizerConfiguration)(configuration.field.name=vocabularyName))"
	)
