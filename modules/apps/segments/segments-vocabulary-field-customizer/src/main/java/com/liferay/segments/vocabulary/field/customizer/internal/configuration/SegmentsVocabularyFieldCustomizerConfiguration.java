...
public interface SegmentsVocabularyFieldCustomizerConfiguration {
	...
	@Meta.AD(
		description = "segments-vocabulary-field-customizer-entity-name-description",
		id = "segments.field.customizer.entity.name",
		name = "segments-vocabulary-field-customizer-entity-name",
		optionLabels = {"%context", "%organization", "%user"},
		optionValues = {"Context", "Organization", "User"}
	)
	...
	@Meta.AD(
		deflt = "-1",
		description = "segments-vocabulary-field-customizer-priority-description",
		id = "segments.field.customizer.priority",
		name = "segments-vocabulary-field-customizer-priority"
	)
	public int priority();
