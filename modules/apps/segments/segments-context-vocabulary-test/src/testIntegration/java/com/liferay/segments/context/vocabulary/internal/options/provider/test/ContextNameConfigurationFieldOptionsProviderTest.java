...
public class ContextNameConfigurationFieldOptionsProviderTest {
	...
	@Inject(
		filter = "(&(configuration.pid=com.liferay.segments.context.vocabulary.internal.configuration.SegmentsContextVocabularyConfiguration)(configuration.field.name=sessionPropertyName))"
	)
