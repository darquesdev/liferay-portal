...
public class SegmentsExperienceUtil {
	 ...
	 * @return the matching segments experiences
	 */
	public static List<SegmentsExperience> findByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		return getPersistence().findByG_C_C_GEP(
			groupId, classNameId, classPK, priority);
	}
	 ...
	 * @throws NoSuchExperienceException if a matching segments experience could not be found
	 */
	public static SegmentsExperience findByG_C_C_GEP_First(
			long groupId, long classNameId, long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws com.liferay.segments.exception.NoSuchExperienceException {

		return getPersistence().findByG_C_C_GEP_First(
			groupId, classNameId, classPK, priority, orderByComparator);
	}
	 ...
	 * @return the first matching segments experience, or <code>null</code> if a matching segments experience could not be found
	 */
	public static SegmentsExperience fetchByG_C_C_GEP_First(
		long groupId, long classNameId, long classPK, int priority,
		OrderByComparator<SegmentsExperience> orderByComparator) {

		return getPersistence().fetchByG_C_C_GEP_First(
			groupId, classNameId, classPK, priority, orderByComparator);
	}
	 ...
	 * @throws NoSuchExperienceException if a matching segments experience could not be found
	 */
	public static SegmentsExperience findByG_C_C_GEP_Last(
			long groupId, long classNameId, long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws com.liferay.segments.exception.NoSuchExperienceException {

		return getPersistence().findByG_C_C_GEP_Last(
			groupId, classNameId, classPK, priority, orderByComparator);
	}
	 ...
	 * @return the last matching segments experience, or <code>null</code> if a matching segments experience could not be found
	 */
	public static SegmentsExperience fetchByG_C_C_GEP_Last(
		long groupId, long classNameId, long classPK, int priority,
		OrderByComparator<SegmentsExperience> orderByComparator) {

		return getPersistence().fetchByG_C_C_GEP_Last(
			groupId, classNameId, classPK, priority, orderByComparator);
	}
	 ...
	 * @throws NoSuchExperienceException if a segments experience with the primary key could not be found
	 */
	public static SegmentsExperience[] findByG_C_C_GEP_PrevAndNext(
			long segmentsExperienceId, long groupId, long classNameId,
			long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws com.liferay.segments.exception.NoSuchExperienceException {

		return getPersistence().findByG_C_C_GEP_PrevAndNext(
			segmentsExperienceId, groupId, classNameId, classPK, priority,
			orderByComparator);
	}
	 ...
	 * @return the matching segments experiences that the user has permission to view
	 */
	public static List<SegmentsExperience> filterFindByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		return getPersistence().filterFindByG_C_C_GEP(
			groupId, classNameId, classPK, priority);
	}
	 ...
	 * @throws NoSuchExperienceException if a segments experience with the primary key could not be found
	 */
	public static SegmentsExperience[] filterFindByG_C_C_GEP_PrevAndNext(
			long segmentsExperienceId, long groupId, long classNameId,
			long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws com.liferay.segments.exception.NoSuchExperienceException {

		return getPersistence().filterFindByG_C_C_GEP_PrevAndNext(
			segmentsExperienceId, groupId, classNameId, classPK, priority,
			orderByComparator);
	}
	 ...
	 * @param priority the priority
	 */
	public static void removeByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		getPersistence().removeByG_C_C_GEP(
			groupId, classNameId, classPK, priority);
	}
	 ...
	 * @return the number of matching segments experiences
	 */
	public static int countByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		return getPersistence().countByG_C_C_GEP(
			groupId, classNameId, classPK, priority);
	}
	 ...
	 * @return the number of matching segments experiences that the user has permission to view
	 */
	public static int filterCountByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		return getPersistence().filterCountByG_C_C_GEP(
			groupId, classNameId, classPK, priority);
	}
