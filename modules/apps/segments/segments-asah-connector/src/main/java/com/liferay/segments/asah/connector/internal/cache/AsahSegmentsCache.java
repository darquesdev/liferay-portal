 ...
 * @author David Arques
 */
@Component(immediate = true, service = AsahSegmentsCache.class)
public class AsahSegmentsCache {
	...
	protected void setMultiVMPool(MultiVMPool multiVMPool) {
		_portalCache = (PortalCache<String, long[]>)multiVMPool.getPortalCache(
			AsahSegmentsCache.class.getName());
	}
	...
	private static final int _TIME_TO_LIVE_IN_SECONDS = 60;
