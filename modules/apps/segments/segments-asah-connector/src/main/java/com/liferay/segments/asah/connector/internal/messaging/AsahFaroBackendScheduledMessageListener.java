...
@Component(
	...
	service = AsahFaroBackendScheduledMessageListener.class
)
public class AsahFaroBackendScheduledMessageListener
	...
	protected void doReceive(Message message) throws Exception {
		_asahFaroBackendCheckerUtil.checkIndividualSegments();
	}

	@Reference(unbind = "-")
	protected void setAsahFaroBackendCheckerUtil(
		AsahFaroBackendCheckerUtil asahFaroBackendCheckerUtil) {

		_asahFaroBackendCheckerUtil = asahFaroBackendCheckerUtil;
	}
	...
	private AsahFaroBackendCheckerUtil _asahFaroBackendCheckerUtil;
