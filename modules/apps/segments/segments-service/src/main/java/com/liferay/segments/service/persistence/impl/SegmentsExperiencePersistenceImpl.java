...
public class SegmentsExperiencePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByG_C_C_GEP;
	private FinderPath _finderPathWithPaginationCountByG_C_C_GEP;

	/**
	 * Returns all the segments experiences where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public List<SegmentsExperience> findByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		return findByG_C_C_GEP(
			groupId, classNameId, classPK, priority, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the segments experiences where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SegmentsExperienceModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the segments experiences where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SegmentsExperienceModelImpl</code>.
	 * </p>
	...
	public List<SegmentsExperience> findByG_C_C_GEP(
		...
		finderPath = _finderPathWithPaginationFindByG_C_C_GEP;
		finderArgs = new Object[] {
			groupId, classNameId, classPK, priority, start, end,
			orderByComparator
		};
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_C_C_GEP_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_C_C_GEP_CLASSNAMEID_2);

			sb.append(_FINDER_COLUMN_G_C_C_GEP_CLASSPK_2);

			sb.append(_FINDER_COLUMN_G_C_C_GEP_PRIORITY_2);
	...
	/**
	 * Returns the first segments experience in the ordered set where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public SegmentsExperience findByG_C_C_GEP_First(
			long groupId, long classNameId, long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws NoSuchExperienceException {

		SegmentsExperience segmentsExperience = fetchByG_C_C_GEP_First(
			groupId, classNameId, classPK, priority, orderByComparator);
	 ...
	 */
	@Override
	public SegmentsExperience fetchByG_C_C_GEP_First(
		long groupId, long classNameId, long classPK, int priority,
		OrderByComparator<SegmentsExperience> orderByComparator) {

		List<SegmentsExperience> list = findByG_C_C_GEP(
			groupId, classNameId, classPK, priority, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last segments experience in the ordered set where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public SegmentsExperience findByG_C_C_GEP_Last(
			long groupId, long classNameId, long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws NoSuchExperienceException {

		SegmentsExperience segmentsExperience = fetchByG_C_C_GEP_Last(
			groupId, classNameId, classPK, priority, orderByComparator);
	 ...
	 */
	@Override
	public SegmentsExperience fetchByG_C_C_GEP_Last(
		long groupId, long classNameId, long classPK, int priority,
		OrderByComparator<SegmentsExperience> orderByComparator) {

		int count = countByG_C_C_GEP(groupId, classNameId, classPK, priority);
	...
	/**
	 * Returns the segments experiences before and after the current segments experience in the ordered set where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param segmentsExperienceId the primary key of the current segments experience
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public SegmentsExperience[] findByG_C_C_GEP_PrevAndNext(
			long segmentsExperienceId, long groupId, long classNameId,
			long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws NoSuchExperienceException {
		...
		try {
			...
			array[0] = getByG_C_C_GEP_PrevAndNext(
				session, segmentsExperience, groupId, classNameId, classPK,
				priority, orderByComparator, true);

			array[1] = segmentsExperience;

			array[2] = getByG_C_C_GEP_PrevAndNext(
				session, segmentsExperience, groupId, classNameId, classPK,
				priority, orderByComparator, false);
	...
	protected SegmentsExperience getByG_C_C_GEP_PrevAndNext(
		Session session, SegmentsExperience segmentsExperience, long groupId,
		long classNameId, long classPK, int priority,
		OrderByComparator<SegmentsExperience> orderByComparator,
		boolean previous) {
	...
	/**
	 * Returns all the segments experiences that the user has permission to view where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public List<SegmentsExperience> filterFindByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		return filterFindByG_C_C_GEP(
			groupId, classNameId, classPK, priority, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the segments experiences that the user has permission to view where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SegmentsExperienceModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the segments experiences that the user has permissions to view where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SegmentsExperienceModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the segments experiences before and after the current segments experience in the ordered set of segments experiences that the user has permission to view where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param segmentsExperienceId the primary key of the current segments experience
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public SegmentsExperience[] filterFindByG_C_C_GEP_PrevAndNext(
			long segmentsExperienceId, long groupId, long classNameId,
			long classPK, int priority,
			OrderByComparator<SegmentsExperience> orderByComparator)
		throws NoSuchExperienceException {
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C_C_GEP_PrevAndNext(
				segmentsExperienceId, groupId, classNameId, classPK, priority,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_C_C_GEP_PrevAndNext(
				session, segmentsExperience, groupId, classNameId, classPK,
				priority, orderByComparator, true);

			array[1] = segmentsExperience;

			array[2] = filterGetByG_C_C_GEP_PrevAndNext(
				session, segmentsExperience, groupId, classNameId, classPK,
				priority, orderByComparator, false);
	...
	protected SegmentsExperience filterGetByG_C_C_GEP_PrevAndNext(
		Session session, SegmentsExperience segmentsExperience, long groupId,
		long classNameId, long classPK, int priority,
		OrderByComparator<SegmentsExperience> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the segments experiences where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	...
	/**
	 * Returns the number of segments experiences where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	...
	public int countByG_C_C_GEP(
		...
		if (productionMode) {
			finderPath = _finderPathWithPaginationCountByG_C_C_GEP;
	...
	/**
	 * Returns the number of segments experiences that the user has permission to view where groupId = &#63; and classNameId = &#63; and classPK = &#63; and priority &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public int filterCountByG_C_C_GEP(
		long groupId, long classNameId, long classPK, int priority) {

		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_C_C_GEP(groupId, classNameId, classPK, priority);
		}
	...
	private static final String _FINDER_COLUMN_G_C_C_GEP_GROUPID_2 =
		"segmentsExperience.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_C_C_GEP_CLASSNAMEID_2 =
		"segmentsExperience.classNameId = ? AND ";

	private static final String _FINDER_COLUMN_G_C_C_GEP_CLASSPK_2 =
		"segmentsExperience.classPK = ? AND ";

	private static final String _FINDER_COLUMN_G_C_C_GEP_PRIORITY_2 =
		"segmentsExperience.priority >= ?";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByG_C_C_GEP = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_C_C_GEP",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithPaginationCountByG_C_C_GEP = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_C_C_GEP",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
