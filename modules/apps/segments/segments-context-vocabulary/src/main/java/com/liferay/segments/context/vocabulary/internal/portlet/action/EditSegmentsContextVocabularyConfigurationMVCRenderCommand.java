...
public class EditSegmentsContextVocabularyConfigurationMVCRenderCommand
		...
		try {
			...
			renderRequest.setAttribute(
				...
				new SegmentsContextVocabularyConfigurationDisplayContext(
					...
					_contextNameConfigurationFieldOptionsProvider.getOptions(),
					_vocabularyNameConfigurationFieldOptionsProvider.
						getOptions()));
	...
	@Reference(
		target = "(&(configuration.field.name=contextName)(configuration.pid=com.liferay.segments.context.vocabulary.internal.configuration.SegmentsContextVocabularyConfiguration))"
	)
	private ConfigurationFieldOptionsProvider
		_contextNameConfigurationFieldOptionsProvider;
	...
	@Reference(
		target = "(&(configuration.field.name=vocabularyName)(configuration.pid=com.liferay.segments.context.vocabulary.internal.configuration.SegmentsContextVocabularyConfiguration))"
	)
	private ConfigurationFieldOptionsProvider
		_vocabularyNameConfigurationFieldOptionsProvider;
