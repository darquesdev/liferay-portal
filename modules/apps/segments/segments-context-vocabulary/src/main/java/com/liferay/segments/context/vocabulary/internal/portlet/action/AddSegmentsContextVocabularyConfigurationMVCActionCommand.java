...
@Component(
	...
	property = {
		...
		"mvc.command.name=/add_segments_context_vocabulary_configuration"
	},
	service = MVCActionCommand.class
)
public class AddSegmentsContextVocabularyConfigurationMVCActionCommand
	...
	protected void doProcessAction(
		...
		_updateConfiguration(
			...
			GetterUtil.get(
				ParamUtil.getString(actionRequest, "contextName"),
				StringPool.BLANK),
			GetterUtil.get(
				ParamUtil.getString(actionRequest, "vocabularyName"),
				StringPool.BLANK));
	...
	private void _updateConfiguration(
			long companyId, Configuration configuration, String contextName,
		...
		try {
			...
			configuredProperties.put("contextName", contextName);
			configuredProperties.put("vocabularyName", vocabularyName);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddSegmentsContextVocabularyConfigurationMVCActionCommand.class);
